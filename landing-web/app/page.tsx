...
const CONFIG = {
  appName: "Pulse",
  tagline: "Tinder-style Prediction Markets on Movement",
  description:
    "Swipe right to bet YES, left to bet NO. Instant settlements powered by Movement blockchain.",
  apkUrl: "", // Add APK download URL after EAS build
  appetizeUrl: "", // Add Appetize embed URL after upload
  githubRepo: "https://github.com/user/pulse", // Update with actual repo
  features: ["Swipe-to-Predict", "Real-time Odds", "Instant Payouts", "Movement Powered"],
};
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <ul className="list-inside list-disc space-y-1 text-sm text-zinc-500">
                    ...
                    <li>Expo Go app on your phone (for physical device)</li>
                  </ul>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  {[
                    ...
                    { label: "Navigate to mobile app", cmd: "cd pulse/mobile" },
